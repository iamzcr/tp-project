...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <a class="btn btn-primary" href="<?php echo U('Banner/add/');?>"> 新增</a>
        </div>
    </div>
    <!-- /.row -->
    <div class="row">
                    ...
                    <div class="dataTable_wrapper">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
                                    ...
                                    <td><img width="80px" src="/deep_shop/Public/Uploads/banner/<?php echo ($list["images"]); ?>"></td>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-danger" href="<?php echo U('Banner/delete',array('banner_id'=>$list['banner_id']));?>">删除</a>
                                    </td>
