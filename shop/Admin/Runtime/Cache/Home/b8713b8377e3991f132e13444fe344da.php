        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> 基本设置<span class="fa arrow"></span></a>
                    ...
                    <li>
                        <a href="<?php echo U('Brand/index/');?>"><i class="fa fa-dashboard fa-fw"></i>品牌管理</a>
                    </li>
                    <li>
                        <a href="<?php echo U('Tag/index/');?>"><i class="fa fa-dashboard fa-fw"></i>标签管理</a>
                    </li>
                    <li>
                        <a href="<?php echo U('Product/index/');?>"><i class="fa fa-dashboard fa-fw"></i>产品管理</a>
                    </li>
                    <li>
                        <a href="<?php echo U('Coupon/index/');?>"><i class="fa fa-dashboard fa-fw"></i>优惠管理</a>
                    </li>
                    <li>
                        <a href="<?php echo U('Bonus/index/');?>"><i class="fa fa-dashboard fa-fw"></i>红包管理</a>
                    </li>
                    <li>
                        <a href="<?php echo U('Banner/index/');?>"><i class="fa fa-dashboard fa-fw"></i>广告管理</a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> CMS<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="<?php echo U('CmsCategory/index/');?>">CMS分类</a>
                            </li>
                            <li>
                                <a href="<?php echo U('CmsPost/index/');?>">CMS文章</a>
                            </li>
                        </ul>
                    </li>
                </ul>
                ...
                <div class="panel-body">
                    <form role="form" method="post">
                        <div class="form-group">
                            <label>标签名字</label>
                            <input class="form-control" name="tag[name]" type="text">
                        </div>
                        <div class="form-group">
                            <label>标签别名</label>
                            <input class="form-control"  name="tag[slug]" type="text">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="radio">
                                <label>
                                    <input type="radio" name="tag[if_show]" id="optionsRadios1" value="1" checked>显示
                                </label>
                            </div>
                            <div class="radio">
                                <label>
                                    <input type="radio" name="tag[if_show]" id="optionsRadios2" value="0">隐藏
                                </label>
                            </div>
                        </div>
                        <input type="submit" class="btn btn-default" value="保存">
                        <a class="btn btn-default" href="<?php echo U('Tag/index/');?>">返回</a>
                    </form>
                </div>
            </div>
        </div>
