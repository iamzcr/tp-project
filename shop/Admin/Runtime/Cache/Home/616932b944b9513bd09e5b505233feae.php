                ...
                <div class="panel-body">
                    <form role="form" method="post">
                        <div class="form-group">
                            <label>摘要</label>
                            <textarea class="form-control" rows="5" cols="4" name="deep[summary]"><?php echo ($deep_summary); ?></textarea>
                        </div>
                        <div class="form-group">
                            <label>详细介绍</label>

                            <textarea   id = "container" name="deep[content]"><?php echo ($deep_content); ?></textarea>
                        </div>
