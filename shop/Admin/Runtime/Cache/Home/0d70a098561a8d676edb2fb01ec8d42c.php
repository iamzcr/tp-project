                ...
                <div class="panel-body">
                    <form role="form" method="post"  enctype="multipart/form-data">
                        <div class="form-group">
                            <label>名字</label>
                            <input class="form-control" name="product[name]" type="text">
                        </div>
                        <div class="form-group">
                            <label>分类</label>
                            <select class="form-control" name="product[cate_id]">
                                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><option value="<?php echo ($list["cate_id"]); ?>"><?php echo ($list["cate_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>
                        <div class="form-group">
                            <label>品牌</label>
                            <select class="form-control" name="product[brand_id]">
                                <?php if(is_array($brandData)): $i = 0; $__LIST__ = $brandData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$brand_list): $mod = ($i % 2 );++$i;?><option value="<?php echo ($brand_list["brand_id"]); ?>"><?php echo ($brand_list["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>
                        <div class="form-group">
                            <label>进货价</label>
                            <input class="form-control" name="product[input_price]" type="text">
                        </div>
                        <div class="form-group">
                            <label>市场价</label>
                            <input class="form-control" name="product[market_price]" type="text">
                        </div>
                        <div class="form-group">
                            <label>销售价</label>
                            <input class="form-control" name="product[price]" type="text">
                        </div>
                        <div class="form-group">
                            <label>库存</label>
                            <input class="form-control" name="product[stock]" type="text">
                        </div>
                        <div class="form-group">
                            <label>图片</label>
                        ...
                        <div class="form-group">
                            <label>描述</label>
                            <textarea  id = "container" rows="5" name="product[description]"  ></textarea>
                        </div>

                        <div class="form-group">
                            <label>标签:</label>
                            <?php if(is_array($tagData)): $i = 0; $__LIST__ = $tagData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tag_list): $mod = ($i % 2 );++$i;?><label class="checkbox-inline">
                                    <input type="checkbox" name="product[tag_ids][]" value="<?php echo ($tag_list["tag_id"]); ?>"><?php echo ($tag_list["name"]); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="radio-inline">
                                <label >
                                    <input type="radio" name="product[if_features]" id="optionsRadios1" value="1" checked>是
                                </label>
                            </div>
                            <div class="radio-inline">
                                <label>
                                    <input type="radio" name="product[if_features]" id="optionsRadios2" value="0">否
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="radio-inline">
                                <label>
                                    <input type="radio" name="product[if_recommend]" id="optionsRadios1" value="1" checked>是
                                </label>
                            </div>
                            <div class="radio-inline">
                                <label>
                                    <input type="radio" name="product[if_recommend]" id="optionsRadios2" value="0">否
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="radio-inline">
                                <label>
                                    <input type="radio" name="product[if_show]" id="optionsRadios1" value="1" checked>显示
                                </label>
                            </div>
                            <div class="radio-inline">
                                <label>
                                    <input type="radio" name="product[if_show]" id="optionsRadios2" value="0">隐藏
                                </label>
                            </div>
                        </div>
                        <input type="submit" class="btn btn-default" value="保存">
                        <a class="btn btn-default" href="<?php echo U('Product/index/');?>">返回</a>
                    </form>
                </div>
            </div>
        </div>
