                ...
                <div class="panel-body">
                    <form role="form" method="post">
                        <div class="form-group">
                            <label>商城名字</label>
                            <input class="form-control" name="deep[name]" type="text" value="<?php echo ($deep_name); ?>">
                        </div>
                        <div class="form-group">
                            <label>电话</label>
                            <input class="form-control" name="deep[phone]" type="text" value="<?php echo ($deep_phone); ?>">
                        </div>
                        <div class="form-group">
                            <label>传真</label>
                            <input class="form-control" name="deep[fax]" type="text" value="<?php echo ($deep_fax); ?>">
                        </div>
                        <div class="form-group">
                            <label>邮箱</label>
                            <input class="form-control" name="deep[email]" type="text" value="<?php echo ($deep_email); ?>">

                        </div>
                        <div class="form-group">
                            <label>地址</label>
                            <textarea class="form-control" rows="5" name="deep[address]"><?php echo ($deep_address); ?></textarea>
                        </div>
