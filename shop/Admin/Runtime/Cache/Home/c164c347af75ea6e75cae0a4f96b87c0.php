                ...
                <div class="panel-body">
                    <form role="form" method="post">
                        <div class="form-group">
                            <label>标题</label>
                            <input class="form-control" name="deep[title]" type="text" value="<?php echo ($deep_title); ?>">
                        </div>
                        <div class="form-group">
                            <label>关键字</label>
                            <input class="form-control" name="deep[keyword]" type="text" value="<?php echo ($deep_keyword); ?>">
                        </div>
                        <div class="form-group">
                            <label>描述</label>
                            <textarea class="form-control" rows="5" name="deep[seo]"><?php echo ($deep_seo); ?></textarea>
                        </div>
