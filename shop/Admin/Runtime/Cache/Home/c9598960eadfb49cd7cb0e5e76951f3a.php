                    ...
                    <div class="dataTable_wrapper">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <th>运费</th>
                                <th>运费单号</th>
                                <th>订单状态（0新建 1等待支付 2已支付<br/> 3已发货 4已完成/已收货 5已取消）</th>
                                <th>支付状态（0未支付<br/> 1已支付）</th>
                                <th>支付方式（0未知/未定义<br/> 1支付宝 2微信 3银联 ）</th>
                                <th>创建时间</th>
                                <th>更新时间</th>
                                <th>操作</th>
                            </tr>
                            ...
                            <tbody>
                            <?php if(is_array($order_list)): $i = 0; $__LIST__ = $order_list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
                                    <td><?php echo ($list["invoice_number"]); ?></td>
                                    <td><?php echo ($list["amount"]); ?></td>
                                    <td><?php echo ($list["shipping_fee"]); ?></td>
                                    <td><?php echo ($list["delivery_number"]); ?></td>
                                    <td><?php echo ($list["status"]); ?></td>
                                    <td><?php echo ($list["payment_status"]); ?></td>
                                    <td><?php echo ($list["payment_type"]); ?></td>
                                    <td><?php echo (date("Y-m-d",$list["created_time"])); ?></td>
                                    <td><?php echo (date("Y-m-d",$list["updated_time"])); ?></td>
                                    <td>
                                        <a class="btn btn-primary">发货</a>
                                        <a class="btn btn-danger">详情</a>
                                    </td>
