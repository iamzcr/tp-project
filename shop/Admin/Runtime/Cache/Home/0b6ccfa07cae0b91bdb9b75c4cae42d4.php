...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <a class="btn btn-primary" href="<?php echo U('Coupon/add/');?>"> 新增</a>
        </div>
    </div>
    <div class="row">
                ...
                <div class="panel-body">
                    ...
                    <div class="dataTable_wrapper">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                            <?php if(is_array($coupon_list)): $i = 0; $__LIST__ = $coupon_list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
                                    <td><?php echo ($list["name"]); ?></td>
                                    <td><?php echo ($list["type"]); ?></td>
                                    <td><?php echo ($list["coupon_price"]); ?></td>
                                    <td><?php echo ($list["order_price"]); ?></td>
                                    <td><?php echo (date("Y-m-d",$list["begin_time"])); ?></td>
                                    ...
                                    <td>
                                        <a class="btn btn-danger" href="<?php echo U('Coupon/delete',array('coupon_id'=>$list['coupon_id']));?>">删除</a>
                                    </td>
